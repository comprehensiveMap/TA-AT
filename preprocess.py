...
class Preprocessor(object):
    def __init__(self, dataset):
        ...
        self.data_dir = os.path.join("data/{}".format(dataset))
        ...
        self.db = MultiWozDB(os.path.join(self.data_dir, "db"), self.dataset)
    ...
    def get_db_values(self):
        ...
        for domain, slots in value_set.items():
            ...
            for slot, values in slots.items():
                ...
                if s_p in definitions.INFORMABLE_SLOTS[self.dataset][domain]:
    ...
    def preprocess_db(self):
        dbs = {}
        for domain in definitions.ALL_DOMAINS[self.dataset]:
        ...
        for fn, raw_dial in tqdm(list(self.data.items())):
            ...
            for dom, g in raw_dial['goal'].items():
                if dom != 'topic' and dom != 'message' and g:
                    ...
                    if dom in definitions.ALL_DOMAINS[self.dataset]:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-dataset", type=str, default="multiwoz_2.0", choices=["multiwoz_2.0", "multiwoz_2.1", "multiwoz_2.2"])
