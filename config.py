...
def add_config(parser):
    ...
    group.add_argument("-task", type=str, default="e2e",
                       choices=["dst", "e2e"])
    group.add_argument("-dataset", type=str, default="multiwoz_2.0",
                       choices=["multiwoz_2.0", "multiwoz_2.1", "multiwoz_2.2", "camrest"])
    group.add_argument("-add_auxiliary_task", action="store_true")
    group.add_argument("-add_additional_loss", action="store_true")
    group.add_argument("-with_tree", action="store_true")
    group.add_argument("-mix_p", type=float, default=1)
    group.add_argument("-mu", type=int, default=10)
    group.add_argument("-st", action="store_true")
    group.add_argument("-sc", action="store_true")
    group.add_argument("-act", action="store_true")
    group.add_argument("-rk", action="store_true")
    group.add_argument("-context_size", type=int, default=-1)
    group.add_argument("-train_data_ratio", type=float, default=1.0)
